...
describe('Schema Unit Tests', () => {
  describe("DB Schema", () => {
    ...
    describe('DB_DATABASE', () => {
      test('Invalid cases for DB_DATABASE', () => {
      ...
      test('valid cases for DB_DATABASE', () => {
        const arrange = [
          true, false
        ]

        arrange.forEach((value) => {
          expectValidate(schema, { DB_HOST: value }).not.toContain('DB_CONNECTION')
        })
      })
    })
    ...
    describe('DB_AUTO_LOAD_MODELS', () => {
      test('Invalid cases for DB_AUTO_LOAD_MODELS', () => {
