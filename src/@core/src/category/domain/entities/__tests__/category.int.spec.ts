...
describe("Category integration tests", () => {
  describe("Create method", () => {
    it("should be a invalid category using name prop", () => {
    ...
    it("should be a invalid category using description prop", () => {
      expect(
    ...
    it("should be a invalid category using is_active prop", () => {
